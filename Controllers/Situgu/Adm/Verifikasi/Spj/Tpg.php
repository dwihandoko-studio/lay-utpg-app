...
namespace App\Controllers\Situgu\Adm\Verifikasi\Spj;

use App\Controllers\BaseController;
use App\Models\Situgu\Adm\Spj\VerifikasispjtpgdetailModel;
use App\Models\Situgu\Adm\Spj\VerifikasispjtpgsekolahModel;
use Config\Services;
...
class Tpg extends BaseController
{
    ...
    public function data()
    {
        ...
        return view('situgu/adm/verifikasi/spj/tpg/index', $data);
    }
    ...
    public function datalist()
    {
        ...
        $data['tw'] = $this->_db->table('_ref_tahun_tw')->where('is_current', 1)->orderBy('tahun', 'desc')->orderBy('tw', 'desc')->get()->getRowObject();
        // $data['tws'] = $this->_db->table('_ref_tahun_tw')->orderBy('tahun', 'desc')->orderBy('tw', 'desc')->get()->getResult();
        return view('situgu/adm/verifikasi/spj/tpg/detail_index', $data);
    }
    ...
    public function detail()
    {
        ...
        if (!$this->validate($rules)) {
            ...
            if ($current) {
                ...
                $response->data = view('situgu/adm/verifikasi/spj/tpg/detail', $data);
                return json_encode($response);
            } else {
                $response = new \stdClass;
                $response->status = 400;
    ...
    public function formtolak()
    {
        ...
        if (!$this->validate($rules)) {
            ...
            $response->status = 200;
            $response->message = "Permintaan diizinkan";
            $response->data = view('situgu/adm/verifikasi/spj/tpg/tolak', $data);
            return json_encode($response);
        }
    }
