...
namespace App\Controllers\Situgu\Opsr\Upload\Ptk;

use App\Controllers\BaseController;
use App\Models\Situgu\Opsr\Ptk\Upload\PangkatkgbModel;
use Config\Services;
...
class Pangkatkgb extends BaseController
{
    ...
    public function index()
    {
        ...
        return redirect()->to(base_url('situgu/opsr/upload/ptk/pangkatkgb/data'));
    }
    ...
    public function data()
    {
        ...
        $data['user'] = $user->data;
        return view('situgu/opsr/upload/ptk/pangkatkgb/index', $data);
    }
    ...
    public function upload()
    {
        ...
        if (!$this->validate($rules)) {
            ...
            $response->data = view('situgu/opsr/upload/ptk/pangkatkgb/upload');
            return json_encode($response);
        }
    }
        ...
        if (!$this->validate($rules)) {
            ...
            foreach ($sheet as $key => $data) {
                ...
                $dataInsert = [
                    ...
                    'total_jjm' => $data[8],
                    'nomor_sk_pangkat' => $data[9],
                    'pangkat_golongan' => $data[10],
                    'tgl_sk_pangkat' => $data[11],
                    'tmt_pangkat' => $data[12],
                    'masa_kerja_tahun' => $data[13],
                    'masa_kerja_bulan' => $data[14],
                    'sk_kgb' => $data[15],
                    'pangkat_golongan_kgb' => $data[16],
                    'tgl_sk_kgb' => $data[17],
                    'tmt_sk_kgb' => $data[18],
                    'masa_kerja_tahun_kgb' => $data[19],
                    'masa_kerja_bulan_kgb' => $data[20],
                ];
            ...
            if ($this->_db->affectedRows() > 0) {
                ...
                $response->data = view('situgu/opsr/upload/ptk/pangkatkgb/verifi-upload', $x);
        ...
        if (isset($datas['data']) && count($datas['data']) > 0) {
            ...
            foreach ($datas['data'] as $key => $v) {
                ...
                if ($v['data_ptk'] == NULL || $v['data_ptk'] == "") {
                    ...
                    $item['tgl_sk_pangkat'] = "";
                    $item['tmt_pangkat'] = "";
                    $item['masa_kerja_tahun'] = "";
                    $item['masa_kerja_bulan'] = "";
                    $item['pangkat_golongan_kgb'] = "";
                    $item['sk_kgb'] = "";
                    $item['tgl_sk_kgb'] = "";
                    $item['tmt_sk_kgb'] = "";
                    $item['masa_kerja_tahun_kgb'] = "";
                    $item['masa_kerja_bulan_kgb'] = "";
                    $item['jam_mengajar_perminggu'] = "";
                    $item['mengajar_lain_satmikal'] = "";
                    $item['nama'] = "";
                    $item['nuptk'] = "";
                    ...
                    $item['tgl_sk_pangkat'] = $v['data_ptk']['tgl_sk_pangkat'];
                    $item['tmt_pangkat'] = $v['data_ptk']['tmt_pangkat'];
                    $item['masa_kerja_tahun'] = $v['data_ptk']['masa_kerja_tahun'];
                    $item['masa_kerja_bulan'] = $v['data_ptk']['masa_kerja_bulan'];
                    $item['pangkat_golongan_kgb'] = $v['data_ptk']['pangkat_golongan_kgb'];
                    $item['sk_kgb'] = $v['data_ptk']['sk_kgb'];
                    $item['tgl_sk_kgb'] = $v['data_ptk']['tgl_sk_kgb'];
                    $item['tmt_sk_kgb'] = $v['data_ptk']['tmt_sk_kgb'];
                    $item['masa_kerja_tahun_kgb'] = $v['data_ptk']['masa_kerja_tahun_kgb'];
                    $item['masa_kerja_bulan_kgb'] = $v['data_ptk']['masa_kerja_bulan_kgb'];
                    $item['jam_mengajar_perminggu'] = $v['data_ptk']['jam_mengajar_perminggu'];
                    $item['mengajar_lain_satmikal'] = $v['data_ptk']['mengajar_lain_satmikal'];
