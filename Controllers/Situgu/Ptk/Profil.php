            ...
            if ($current) {
                ...
                switch ($id) {
                    ...
                    case 'aktivasi_wa':
                        ...
                        break;
                    case 'aktivasi_telegram':
                        $response->data = view('situgu/ptk/profil/aktivasi_telegram', $data);
                        break;
            ...
            if ($current) {
                ...
                switch ($id) {
                    ...
                    case 'aktivasi_wa':
                        ...
                        break;
                    case 'aktivasi_telegram':
                        $response->data = view('situgu/ptk/profil/ubah_aktivasi_telegram', $data);
                        break;
