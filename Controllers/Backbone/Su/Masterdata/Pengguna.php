...
namespace App\Controllers\Backbone\Su\Masterdata;

use App\Controllers\BaseController;
use App\Models\Backbone\Su\PenggunaModel;
use Config\Services;
...
class Pengguna extends BaseController
{
    ...
    function __construct()
    {
        ...
        $this->_db      = \Config\Database::connect('backbone');
    }
    ...
    {
        return redirect()->to(base_url('backbone/su/masterdata/pengguna/data'));
    }
    ...
    public function data()
    {
        ...
        $data['user'] = $user->data;
        $data['roles'] = $this->_db->table('_role_user')->whereIn('id', [2, 3, 4, 5, 6, 7, 8, 9])->get()->getResult();

        return view('backbone/su/masterdata/pengguna/index', $data);
    }
    ...
    public function getWilayahShow()
    {
        ...
        if (!$this->validate($rules)) {
            ...
            if ($wilayahs) {
                ...
                $response->data = view('backbone/su/masterdata/pengguna/wilayahs', $data);
                return json_encode($response);
            } else {
                $response = new \stdClass;
                $response->status = 400;
    ...
    public function getSekolahShow()
    {
        ...
        if (!$this->validate($rules)) {
            ...
            if ($sekolahs) {
                ...
                $response->status = 200;
                $response->message = "Permintaan diizinkan";
                $response->data = view('backbone/su/masterdata/pengguna/sekolahs', $data);
                return json_encode($response);
            } else {
                $response = new \stdClass;
                $response->status = 400;
    ...
    public function add()
    {
        ...
        if (!$this->validate($rules)) {
            ...
            if (count($roles) > 0 && count($wilayahs) > 0) {
                ...
                $response->status = 200;
                $response->message = "Permintaan diizinkan";
                $response->data = view('backbone/su/masterdata/pengguna/add', $data);
                return json_encode($response);
            } else {
                $response = new \stdClass;
                $response->status = 400;
    ...
    public function addAkunSekolah()
    {
        ...
        if (!$this->validate($rules)) {
            ...
            if (count($roles) > 0 && count($wilayahs) > 0) {
                ...
                $response->status = 200;
                $response->message = "Permintaan diizinkan";
                $response->data = view('backbone/su/masterdata/pengguna/add_sekolah', $data);
                return json_encode($response);
            } else {
                $response = new \stdClass;
                $response->status = 400;
    ...
    public function addRayon()
    {
        ...
        if (!$this->validate($rules)) {
            ...
            if (count($sekolahs) > 0) {
                ...
                $response->status = 200;
                $response->message = "Permintaan diizinkan";
                $response->data = view('backbone/su/masterdata/pengguna/add_rayon', $data);
                return json_encode($response);
            } else {
                $response = new \stdClass;
                $response->status = 400;
    ...
    public function addSaveSekolah()
    {
        if ($this->request->getMethod() != 'post') {
            $response = new \stdClass;
            $response->status = 400;
    ...
    public function edit()
    {
        ...
        if (!$this->validate($rules)) {
            ...
            if ($current) {
                ...
                $response->status = 200;
                $response->message = "Permintaan diizinkan";
                $response->data = view('backbone/su/masterdata/pengguna/edit', $data);
                return json_encode($response);
            } else {
                $response = new \stdClass;
                $response->status = 400;
    ...
    public function editSave()
    {
        ...
        if (!$this->validate($rules)) {
            ...
            if (
                ...
                $response->redirect = base_url('backbone/su/masterdata/pengguna');
                return json_encode($response);
            }
    ...
    public function import()
    {
        ...
        $data['user'] = $user->data;
        return view('backbone/su/masterdata/pengguna/import', $data);
    }
