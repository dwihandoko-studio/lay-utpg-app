                    ...
                    <?php if (isset($user)) { ?>
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu" aria-labelledby="topnav-setting">
                                ...
                                <a href="<?= base_url('situgu/su/setting/accesssyncronebackbone') ?>" class="dropdown-item <?= ($uri->getSegment(2) == "su" && $uri->getSegment(3) == "setting" && $uri->getSegment(4) == "accesssyncronebackbone") ? ' active-menu-href' : '' ?>" key="t-setting-accesssyncronebackbone">Granted Access Syncrone Backbone</a>
