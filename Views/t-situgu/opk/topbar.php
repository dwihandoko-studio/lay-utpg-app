                    ...
                    <?php if (isset($user)) { ?>
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu" aria-labelledby="topnav-verifikasi">
                                ...
                                <a href="<?= base_url('situgu/opk/verifikasi/spj/tpg') ?>" class="dropdown-item <?= ($uri->getSegment(2) == "opk" && $uri->getSegment(3) == "verifikasi" && $uri->getSegment(4) == "spj" && $uri->getSegment(5) == "tpg") ? ' active-menu-href' : '' ?>" key="t-verifikasi-spj-tpg">SPJ Tunjangan Profesi Guru</a>
                                <a href="<?= base_url('situgu/opk/verifikasi/spj/tamsil') ?>" class="dropdown-item <?= ($uri->getSegment(2) == "opk" && $uri->getSegment(3) == "verifikasi" && $uri->getSegment(4) == "spj" && $uri->getSegment(5) == "tamsil") ? ' active-menu-href' : '' ?>" key="t-verifikasi-spj-tamsil">SPJ Tamsil</a>
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu" aria-labelledby="topnav-sptjm">
                                ...
                                <a href="<?= base_url('situgu/opk/sptjm/spjtpg') ?>" class="dropdown-item <?= ($uri->getSegment(2) == "opk" && $uri->getSegment(3) == "sptjm" && $uri->getSegment(4) == "spjtpg") ? ' active-menu-href' : '' ?>" key="t-sptjm-spjtpg">SPJ Tunjangan Profesi Guru</a>
                                <a href="<?= base_url('situgu/opk/sptjm/spjtamsil') ?>" class="dropdown-item <?= ($uri->getSegment(2) == "opk" && $uri->getSegment(3) == "sptjm" && $uri->getSegment(4) == "spjtamsil") ? ' active-menu-href' : '' ?>" key="t-sptjm-spjtamsil">SPJ Tamsil</a>
                            </div>
                        </li>
                        <li class="nav-item dropdown">
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle arrow-none <?= ($uri->getSegment(2) == "opk" && $uri->getSegment(3) == "upload") ? ' active-menu-href' : '' ?>" href="javascript:;" id="topnav-upload" role="button">
                            ...
                            <div class="dropdown-menu" aria-labelledby="topnav-upload">
                                <a href="<?= base_url('situgu/opk/upload/ptk/pangkatkgb') ?>" class="dropdown-item <?= ($uri->getSegment(2) == "opk" && $uri->getSegment(3) == "upload" && $uri->getSegment(4) == "ptk"  && $uri->getSegment(5) == "pangkatkgb") ? ' active-menu-href' : '' ?>" key="t-upload-ptk-pangkatkgb">Pangkat KGB</a>
                            </div>
                        </li>
                        <!-- <li class="nav-item dropdown">
